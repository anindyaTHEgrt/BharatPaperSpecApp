...
import {Share2, Download, MailPlus  } from "lucide-react";

const Fab = ({filepath, fileName}) => {
    ...
    const handleDownload = (path, fileName) => {
        ...
        // Use the provided fileName or extract it from the path
    ...
    return (
        <div>
            <div className="fab">
                ...
                {/*Download Button*/}
                <button className="btn btn-primary btn-lg btn-circle" onClick={() => handleDownload(filepath, fileName)}>
                ...
                <button className="btn btn-primary btn-lg btn-circle">
                    <svg width="24"
                         height="24"
                         viewBox="0 0 24 24"
                         className="fill-white" // Tailwind class
